                ...
                <CardContent className="p-4 h-full flex items-center">
                  ...
                  <div className="hidden md:block lg:hidden w-full">
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <div className="flex items-center gap-2 flex-shrink-0" style={{ width: "140px" }}>
                        ...
                        <div className="text-center flex-1">
                          ...
                          <div className="flex items-center justify-center gap-1">
                            <StarRating rating10={casino.rating} size="h-2.5 w-2.5" gapClass="gap-0.5" />
                            <span className="text-white font-semibold text-base">{casino.rating.toFixed(1)}</span>
                          </div>
                        </div>
                      </div>
                      ...
                      {/* Features Column */}
                      <div
                        className="flex flex-col gap-1 flex-shrink-0 min-h-[60px] justify-center"
                        style={{ width: "120px" }}
                      >
                        {casino.features.map((feature, index) => (
                          <Badge
                            key={index}
                            variant="outline"
                            className="border-red-900/70 text-gray-300 bg-red-950 text-[9px] px-1 py-0.5 text-center justify-center w-full relative z-10 font-bold"
                          >
                            {feature}
                          </Badge>
                        ))}
